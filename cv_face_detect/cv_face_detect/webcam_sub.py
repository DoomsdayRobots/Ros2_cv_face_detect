...
# A basic ROS 2 program to subscribe to real-time streaming with face detection.
...
class ImageSubscriber(Node):
	...
	def listener_callback(self, data):
		...
		# Display image
		# Enable or dissable this to see your output.
		# If dissabled, this can still be viewed in 
		# rviz2 whith the addition of a new image
